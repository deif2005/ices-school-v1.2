...
import cn.mteach.examclient.service.ExamPaperService;
...
public class ExamPage {
	...
	public String examStartPage(Model model, HttpServletRequest request, @PathVariable("examId") int examId) {
		...
		sb.append("<script>sessionStorage.imageExamTimeId="+examId+"</script>");
	 ...
	 * @return
	 */
	@RequestMapping(value = "/student/exam/model-test-start/{examId}", method = RequestMethod.GET)
	 ...
	 * @return
	 */
	@RequestMapping(value = "/student/usercenter/student-answer-sheet/{examId}", method = RequestMethod.GET)
	private String studentAnswerSheetPage(Model model, HttpServletRequest request, @PathVariable int examId) {
		...
		model.addAttribute("exampaperTotalScore", examPaper.getTotalPoint());
		...
		model.addAttribute("examId", history.getExamId());
		model.addAttribute("examTotalScore", history.getPointGet());

		return "student-answer-sheet";
	}
	
	@RequestMapping(value = "student/usercenter/finish-exam/{examId}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "student/exam/finished-submit", method = RequestMethod.GET)
