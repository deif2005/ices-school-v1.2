...
public class UserCenterPage {
	...
	@RequestMapping(value = "student/usercenter/userInfo", method = RequestMethod.GET)
	...
	@RequestMapping(value = "student/usercenter/analysis", method = RequestMethod.GET)
	public String userAnalysisDefaultPage(Model model, HttpServletRequest request) {
		List<Field>  fieldList = questionService.getAllField(null);
		return "redirect:/student/usercenter/analysis/"+ fieldList.get(0).getFieldId();
	}
	 ...
	 * @return
	 */
	@RequestMapping(value = "student/usercenter/analysis/{fieldId}", method = RequestMethod.GET)
	...
	@RequestMapping(value = "student/usercenter/exam-history", method = RequestMethod.GET)
	public String userExamHistPage(Model model, HttpServletRequest request){
		...
		String pageStr = PagingUtil.getPagelink(index, pageModel.getTotalPage(), "", "student/usercenter/exam-history");
	...
	public String userInfoPage(Model model, HttpServletRequest request, @PathVariable("userName") String userName) {
		...
		return "redirect:/student/usercenter/userInfo";
	}
