...
//			sb.append("<textarea class=\"question-textarea\"></textarea>");
            sb.append("<script type=\"text/plain\" id=\"textarea"+questionQueryResult.getQuestionId()+"\"  class=\"question-textarea\" style=\"width:100%;height: 100px;\"></script>");
...
//			sb.append("<textarea class=\"question-textarea\"></textarea>");
		...
		sb.append("<p>");
		sb.append(questionQueryResult.getReferenceName() == null ? "" : questionQueryResult.getReferenceName());
		sb.append("</p></div></div>");
		sb.append("<div class=\"answer-desc-detail\">");
		...
		sb.append("<div class=\"answer-desc-content\">");
		sb.append("<p>");
		sb.append(questionQueryResult.getAnalysis() == null ? "" : questionQueryResult.getAnalysis());
		sb.append("</p></div></div>");
		sb.append("<div class=\"answer-desc-detail\">");
...
//			sb.append("<textarea class=\"question-textarea\"></textarea>");
	...
	public String replaceImg(String sb){
		String reg="<img class=\"question-content-img question-img.*?>";
		String regOpt="<img class=\"question-opt-img question-img.*?>";
		String content=sb.toString();
		content=content.replaceAll(reg,"").replaceAll(regOpt,"");
		return content;
	}
}
