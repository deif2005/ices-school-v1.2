...
var dashboard = {
	...
	drawStudentApprovedTable : function drawStudentApprovedTable(ehlist) {
		...
		for(var i = 0 ; i < ehlist.length ; i++){
			...
			html += "</td>";
			html += "<td>";
			html += "<span class=\"approved-btn btn-sm btn-success\" data-id=\"" + ehlist[i].histId + "\">审核</span><span class=\"disapproved-btn btn-sm btn-warning\" data-id=\"" + ehlist[i].histId + "\">拒绝</span>"
			html += "</td>";
			html += "</tr>";
