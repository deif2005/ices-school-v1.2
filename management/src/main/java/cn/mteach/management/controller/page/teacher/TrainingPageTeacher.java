package cn.mteach.management.controller.page.teacher;

import cn.mteach.common.domain.practice.KnowledgePointAnalysisResult;
import cn.mteach.common.domain.practice.TypeAnalysis;
import cn.mteach.common.domain.question.Field;
import cn.mteach.common.domain.question.QuestionStatistic;
...
import cn.mteach.management.service.QuestionHistoryService;
...
public class TrainingPageTeacher {
	...
	public String trainingListPage(Model model, HttpServletRequest request, @RequestParam(value="page",required=false,defaultValue="1") int page) {
		...
		String pageStr = PagingUtil.getPagelink(page, pageModel.getTotalPage(), "", "teacher/training/training-list");
	...
	public String sectionPage(Model model,  @RequestParam(value="page",required=false,defaultValue="1") int index, @PathVariable int trainingId) {
		Page<TrainingSection> pageModel=new Page<>();
		pageModel.setPageNo(index);
		pageModel.setPageSize(10);
		List<TrainingSection> sectionList = trainingService.getTrainingSectionByTrainingId(trainingId, -1, pageModel);
		String pageStr = PagingUtil.getPagelink(index, pageModel.getTotalPage(), "", "admin/training/section-list/"+trainingId);
