...
public interface TrainingMapper {
	 ...
	 * @param trainingId
	 */
	public void deleteTraining(@Param("trainingId") int trainingId, @Param("userId") int userId);
	 ...
	 * @param userId
	 */
	public void deleteTrainingSectionByTrainingId(@Param("trainingId") int trainingId, @Param("userId") int userId);
